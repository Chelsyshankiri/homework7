...
the target website. You must make your program generate a QR code that takes someone to your GitHub homepage i.e. https://github.com/Chelsyshankiri
...
![Chelsyshankiri git profile](./qr_codes/QRCode_20250409005326.png)

2.  Add an image of viewing the log of successfully creating the QR code below.

![Log Image](Output.png)
